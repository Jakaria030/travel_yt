    ...
    return (
        <div className='pt-20 pb-20'>
            ...
            <div className='w-[80%] mx-auto items-start grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-10'>
                ...
                <div>
                    ...
                    <div className='mt-6'>
                        ...
                        <h1 className='text-base font-bold text-blue-950 mt-1'>+8801725000999</h1>
                    </div>

                    <div className='mt-6'>
                        <h1 className='text-sm text-gray-600'>Our Email</h1>
                        <h1 className='text-base font-bold text-blue-950 mt-1'>tripi@gmail.com</h1>
                    </div>
                </div>
            </div>
            ...
            <div className='mt-8 w-[80%] mx-auto border-t pt-8 flex flex-col md:flex-row justify-between items-center text-gray-600 text-sm'>
                <p className='text-center md:text-left'>Copyright &copy; 2025 Tripi. All rights reserved.</p>

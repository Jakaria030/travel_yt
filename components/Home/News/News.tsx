...
const News = () => {
    return (
        <div className='pt-20 pb-20'>
            ...
            {/* section content */}
            <div className='w-[80%] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10 items-center mt-16'>
                <div>
                ...
                <div>
                    <NewsCard image='/images/n4.jpg' title='Top 10 place to visit in New Zealand' date='5 November 2024' />
                </div>
            </div>
        </div>
    );

...
const Hero = () => {
    return (
        <div className='relative w-full h-[120vh] sm:h-[100vh]'>
            {/* overlay */}
            <div className='absolute left-0 top-0 w-full h-full bg-gray-800 opacity-70'></div>
            ...
            <div className='absolute w-full h-full z-[100] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
                <div className='flex flex-col items-center justify-center w-full h-full'>
                    ...
                    {/* search button */}
                    <Link href='#' className='rounded px-14 md:px-28 py-2.5 -mt-4 overflow-hidden group bg-rose-600 relative hover:bg-gradient-to-r hover:from-red-500 hover:to-red-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-red-400 transition-all ease-out duration-300'>
